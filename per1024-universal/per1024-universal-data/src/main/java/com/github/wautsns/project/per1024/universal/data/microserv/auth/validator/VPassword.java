...
@AConstraint
@VNotNullOrBlank(target = VPassword.TARGET)
@VPattern(
    target = VPassword.TARGET, message = MessagesOfAuth.PASSWORD_IS_INCORRECT,
    regex = "^[a-zA-Z0-9_$]{6,20}$")
public @interface VPassword {

    Validator<String> VALIDATOR
        = AnnotatedValidatorParser.create(VPassword.class, String.class);

    @AVariable
    @AAttribute
    String TARGET = MessagesOfAuth.Target.PASSWORD;
