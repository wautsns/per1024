...
@AConstraint
@VNotNullOrBlank(target = VPhone.TARGET)
@VPattern(target = VPhone.TARGET, regex = "^[+]?[0-9-]+$")
public @interface VPhone {

    Validator<String> VALIDATOR
        = AnnotatedValidatorParser.create(VPhone.class, String.class);

    @AVariable
    @AAttribute
    String TARGET = Messages.Target.PHONE;
